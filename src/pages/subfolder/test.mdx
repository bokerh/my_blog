import { Scrollycoding } from "@/components/code-blocks/scrollycoding";
import { CodeWithTabs } from "@/components/code-blocks/code-tabs";

## 포스트 작성 방법

| 호스트 이름 | 호스트 주소 |                                                호스트 전화번호 |
| :---------- | :---------: | -------------------------------------------------------------: |
| 이름        |  호스주소   | 전화번호 sdf awefwewgwaegeefffffffffffffffffffffffffffffffffff |
